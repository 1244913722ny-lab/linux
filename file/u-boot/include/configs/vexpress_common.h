...
/* 强制覆盖默认启动命令，跳过复杂的 distro 扫描 */
#undef CONFIG_BOOTCOMMAND
#define CONFIG_BOOTCOMMAND \
    "echo '--- [1/6] Loading Kernel... ---'; " \
    "fatload mmc 0:1 0x60000000 zImage; " \
    "echo '--- [2/6] Loading Main DTB... ---'; " \
    "fatload mmc 0:1 0x61000000 main.dtb; " \
    "echo '--- [3/6] Loading Overlay... ---'; " \
    "fatload mmc 0:1 0x62000000 my_overlay.dtbo; " \
    "echo '--- [4/6] Loading Rootfs... ---'; " \
    "fatload mmc 0:1 0x64000000 rootfs.uimg; " \
    "echo '--- [5/6] Applying Device Tree Overlay... ---'; " \
    "fdt addr 0x61000000; " \
    "fdt resize 8192; " \
    "if fdt apply 0x62000000; then echo 'Overlay Applied Successfully!'; else echo 'Overlay Apply FAILED!'; fi; " \
    "echo '--- [6/6] Setting Bootargs & Booting... ---'; " \
